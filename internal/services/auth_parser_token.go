...
func (as *service) NewParser(keyFunc jwt.Keyfunc, method jwt.SigningMethod, newClaims ClaimsFactory) endpoint.Middleware {
	return func(next endpoint.Endpoint) endpoint.Endpoint {
		return func(ctx context.Context, request interface{}) (response interface{}, err error) {
...
func (s *service) ExtractClaims(tokenString string, kf jwt.Keyfunc) (jwt.MapClaims, error) {
